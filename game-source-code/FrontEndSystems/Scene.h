...
public:
	...
	// returns the current vector of all the game objects in the specific scene
...
private:
	...
	/// would be better to use a doubly linked list instead of a vector since it has a better time effeciency 
